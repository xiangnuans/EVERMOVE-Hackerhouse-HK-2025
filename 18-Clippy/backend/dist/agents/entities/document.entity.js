...
exports.DocumentSchema = exports.Document = exports.DocumentType = void 0;
...
__decorate([
    (0, mongoose_1.Prop)({ type: mongoose_2.Schema.Types.ObjectId, ref: 'Agent', required: true }),
    __metadata("design:type", agent_entity_1.Agent)
], Document.prototype, "agent", void 0);
